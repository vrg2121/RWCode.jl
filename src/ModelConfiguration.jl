# Parameterize Run
"Struct to configure the model and error messages to redirect invalid inputs."
module ModelConfiguration

export ModelConfig

"prompts for binary input and redirect for non-binary inputs."
...
- RunImprovement: When set to 1, the model solves for a steady state energy grid with ideal conditions for wind and solar inputs.
...
1
Enter RunImprovement (0 or 1, default=0):
0
