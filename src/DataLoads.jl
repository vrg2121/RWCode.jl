...
function load_data(P)
    ...
    regions_all, Linedata, majorregions_all, Fossilcapital, Renewablecapital, Electricityregionprices = load_csv_data()
    ...
    # create RWParams
    RWParams = fill_RWParams(majorregions_all, P.majorregions, P.regions, Linedata, P.params, wage_init, P.thetaS, P.thetaW, P.popelas, rP_LR);
    ...
    secshares, sectoralempshares = sec_shares!(secshares, sectoralempshares)
    ...
    # FFsupplyCurves
    FFsupplyCurves = fill_FFsupply()

    # GsupplyCurves
    GsupplyCurves = fill_Gsupply()
    ...
    curtmat, samplepointssolar, samplepointswind, samplepointsbat = create_curtmat!(curtmatmx, curtmatmx, curtmatmx, curtmat);

    # import battery requirements
    batteryrequirements = battery_req!(batteryrequirements)
